...
- [ ] Добавить дополнительный механизм кэшрования файлов (скажем, если это относительно небольшой статический контент вроде картинок или простого текста).
